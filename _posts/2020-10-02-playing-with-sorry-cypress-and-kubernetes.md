...
_Updated 11 February 2021_

# Update Feb 2021: You probably don't want to read this post any more...

**There is now a Sorry Cypress Helm chart based on the work I did in this blog post. You can [read more about it here](https://crumbhole.com/indroducing-the-sorry-cypress-helm-chart/).  This blog post really now only exists as a way of explaning how all the elements work together. The Helm chart offers this and much more (including an optional Minio deployment as well as more comprehensive S3 connection  options).**
